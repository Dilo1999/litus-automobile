                ...
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 24px rgba(0,0,0,0.08); overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 28px 32px 8px;">
                            <p style="margin: 0; font-size: 11px; font-weight: 600; letter-spacing: 0.1em; text-transform: uppercase; color: #c19b46;">Free Estimation</p>
                            <h1 style="margin: 6px 0 0; font-size: 22px; font-weight: 600; color: #1a1a1a; letter-spacing: -0.02em;">New Quote Request</h1>
                            <p style="margin: 10px 0 0; font-size: 14px; color: #57534e; line-height: 1.5;">You have received a new quote request from the website.</p>
                        </td>
                    </tr>
                    {{-- Details card --}}
                    <tr>
                                ...
                                <tr>
                                    <td style="padding: 20px 20px 8px;">
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            ...
                                            <tr>
                                                <td style="padding: 0 0 12px; font-size: 12px; font-weight: 600; color: #c19b46; text-transform: uppercase; letter-spacing: 0.06em;">Contact Number</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0 0 16px; font-size: 15px; color: #1a1a1a;">{{ $data['contact_number'] }}</td>
                                            </tr>
                                            @endif
                                            @if(!empty($data['country']))
                                            <tr>
                                                <td style="padding: 0 0 12px; font-size: 12px; font-weight: 600; color: #c19b46; text-transform: uppercase; letter-spacing: 0.06em;">Country</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0 0 16px; font-size: 15px; color: #1a1a1a;">{{ $data['country'] }}</td>
                                            </tr>
                                            @endif
                                            @if(!empty($data['product']))
                                            <tr>
                                                <td style="padding: 0 0 12px; font-size: 12px; font-weight: 600; color: #c19b46; text-transform: uppercase; letter-spacing: 0.06em;">Product</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 0 0 16px; font-size: 15px; color: #1a1a1a;">{{ $data['product'] }}</td>
                                            </tr>
                                            @endif
                                            <tr>
                    ...
                    <tr>
                        <td style="padding: 0 32px 28px; text-align: center;">
                            <a href="mailto:{{ $data['email'] }}?subject=Re: Quote Request from {{ urlencode($data['name']) }}" style="display: inline-block; padding: 14px 28px; background-color: #c19b46; color: #1a1a1a; font-size: 13px; font-weight: 600; text-decoration: none; border-radius: 8px; letter-spacing: 0.04em;">Reply to {{ $data['name'] }}</a>
                        </td>
                    </tr>
                    {{-- Footer --}}
                    <tr>
