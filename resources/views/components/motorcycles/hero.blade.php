<section class="motorcycles-hero relative flex items-end w-full overflow-hidden">
    ...
    <div class="relative z-10 w-full site-container pb-10 md:pb-14 lg:pb-16 pt-24 md:pt-28">
        <div class="max-w-2xl">
            ...
            <p class="text-white/85 text-sm sm:text-base leading-relaxed max-w-xl mb-6">
                Explore our full collection of Honda and Yamaha motorcycles — from city scooters to adventure bikes,
                all with exclusive limited-time offers.
            </p>
            <a href="#ride-collection" class="litus-btn litus-btn--red">View Collection</a>
        </div>
    </div>
